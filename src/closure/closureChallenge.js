/*
    ...
    Usando las closures deberás crear una función 
    a la cual se pueda llamar en primer lugar con un solo número 
    ...
    en algunos casos puede que no se mande el segundo número 
